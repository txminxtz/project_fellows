...
<body>
	<h1>Excluir Adotante</h1>
	<form name="frmAdotante" action="adotante_delete">
		<table>
			<tr>
			...
			<tr>
				<td><input type="text" name="adotante_nome" class="Caixa1" readonly
				value="<%out.print(request.getAttribute("adotante_nome"));%>"></td>
			</tr>
			<tr>
				<td><input type="text" name="adotante_telefone" class="Caixa2" readonly
				value="<%out.print(request.getAttribute("adotante_telefone"));%>"></td>
			</tr>
			<tr>
				<td><input type="text" name="adotante_email" class="Caixa1" readonly
				value="<%out.print(request.getAttribute("adotante_email"));%>"></td>
			</tr>
			<tr>
				<td><input type="password" name="adotante_senha" class="Caixa1" readonly
				value="<%out.print(request.getAttribute("adotante_senha"));%>"></td>
			</tr>
		</table>
		<input type="button" value="Confirma Exclusão" class="Botao1" onclick="adotante_validate()">
	</form>
