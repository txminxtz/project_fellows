...
<body>
	...
	<a class="label_cadastrar" href="animal_adotante_list?adotante_id=<%=adotante_id%>" >
		Retornar
	</a>
		...
		<tbody>
			<%for (int i=0; i<lista.size(); i++) { %>
				...
				<tr>
					...
					<td><a href="animal_adotante_get_adopt?animal_id=<%=lista.get(i).getId()%>&adotante_id=<%=adotante_id%>" class="Botao1">Adotar</a>
				</tr>
